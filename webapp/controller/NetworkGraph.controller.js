...
var GraphController = Controller.extend("demo.ZOrgChart.controller.NetworkGraph");	
	var STARTING_PROFILE = "Mann";
	
		GraphController.prototype.onInit = function () {
		this._oModel = new JSONModel(jQuery.sap.getModulePath("demo.ZOrgChart", "/jsondata/graph.json"));
			...
			if (!this._oQuickView) {
				this._oQuickView = sap.ui.xmlfragment("demo.ZOrgChart.fragments.Tooltip", this);
			}
